...
class Autocompleter(object):
    def __init__(self, phenos):
        ...
        self._cpra_to_rsids_trie = marisa_trie.BytesTrie().load(self, common_filepaths['cpra-to-rsids-trie']())
        self._rsid_to_cpra_trie = marisa_trie.BytesTrie().load(self, common_filepaths['rsid-to-cpra-trie']())
        self._gene_alias_trie = marisa_trie.BytesTrie().load(self, common_filepaths['gene-aliases-trie']())
