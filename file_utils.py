...
common_filepaths = {
    ...
    'manhattan' : (lambda phenocode: get_generated_path('https://broad-ukb-sumstats-us-east-1.s3.amazonaws.com/UKB_GATE/pheweb/manhattan/', '{}.json'.format(phenocode) if phenocode else '')),
